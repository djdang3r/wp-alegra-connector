...
<?php else:foreach($orders as $o):
    $ii=(string)$o->get_meta('_alegra_invoice_id',true);$in=$o->get_meta('_alegra_invoice_number',true);$s=$ii!==''&&$ii!==null;$ist=(string)$o->get_meta('_alegra_invoice_status',true);
    $pi=(string)$o->get_meta('_alegra_payment_id',true);$ps=$pi!==''&&$pi!==null;
